...
// index - 202
const part1 = context.globalThis.usDecrypted(1220 - 202, '4iVX');
const part2 = context.globalThis.usDecrypted(1697 - 202, 'J#Yc');
const part3 = context.globalThis.usDecrypted(1375 - 202, 'RDIL');
