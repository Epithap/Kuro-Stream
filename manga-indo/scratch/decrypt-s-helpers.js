...
console.log('--- Decrypting helpers in s ---');
try { console.log('t(-36, "ipzp") =', t(-36, 'ipzp')); } catch(e){}
try { console.log('t(235, "JviX") =', t(235, 'JviX')); } catch(e){}
try { console.log('t(426, "1!pJ") =', t(426, '1!pJ')); } catch(e){}
