...
console.log('--- Decrypting accessKey config property paths ---');
try { console.log('t(96, "U96T") =', t(96, 'U96T')); } catch(e){}
try { console.log('t(505, "iJ(q") =', t(505, 'iJ(q')); } catch(e){}
try { console.log('t(686, "Zowf") =', t(686, 'Zowf')); } catch(e){}
try { console.log('t(575, "wpLQ") =', t(575, 'wpLQ')); } catch(e){}
